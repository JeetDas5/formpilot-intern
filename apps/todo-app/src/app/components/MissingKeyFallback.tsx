...
export default function MissingKeyFallback() {
  ...
  return (
    <>
      <Navbar />
      <div className="min-h-screen flex flex-col items-center justify-center text-center p-8 bg-gradient-to-br from-blue-50 via-white to-blue-200 text-zinc-800">
